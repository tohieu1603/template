 ...
 * roles: 'admin' | 'staff' | 'customer' | 'customer2'
 */
export async function loginAs(role: 'admin' | 'staff' | 'customer' | 'customer2'): Promise<TokenPair> {
 ...
 */
export async function getToken(role: 'admin' | 'staff' | 'customer' | 'customer2'): Promise<string> {
