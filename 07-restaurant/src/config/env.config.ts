...
export const env = {
  ...
  JWT_ACCESS_SECRET: requireEnv('JWT_ACCESS_SECRET', 'restaurant_access_secret_key_2026'),
  JWT_REFRESH_SECRET: requireEnv('JWT_REFRESH_SECRET', 'restaurant_refresh_secret_key_2026'),
