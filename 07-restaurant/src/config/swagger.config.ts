...
const options: swaggerJsdoc.Options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Restaurant/F&B Backend API',
      version: '1.0.0',
      description: 'Production-ready Restaurant REST API with menu management, table reservation, ordering, kitchen queue, and payment support.',
      contact: { name: 'API Support', email: 'support@restaurant.com' },
    },
